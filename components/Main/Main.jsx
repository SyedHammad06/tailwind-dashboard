...
export const Main = () => (
  <div className='bg-white px-4 mainWidth sm:px-0 sm:px-8 sm:py-10 sm:ml-14 md:ml-64'>
    {/* Top */}
    ...
    {/* Table */}
    <div className='hidden md:flex md:justify-between md:align-bottom mt-2 mb-10'>
    ...
    <table className='w-full rounded-xl text-left md:text-right text-white bg-gradient-to-br from-tableLight to-tableDark'>
      <thead className='border-b-2 border-white'>
        ...
        <th className='w:4/12 md:w-2/12'>Amount</th>
        <th className='w:4/12 md:w-2/12'>Total</th>
        <th className='hidden md:table-cell md:w-2/12'>Status</th>
        <th className='hidden md:table-cell p-4 md:w-3/12'>Date</th>
      </thead>
      <tr>
        <td className='text-left pt-4 pb-2 pl-4 pr-1 md:pl-6 flex items-center'>
          <Image src='/eth.png' alt='ethereum img' width='40' height='40' />
          <p className='ml-4'>Ethereum Purchased</p>
        </td>
        <td className='p-1 md:p-0'>0.0154 ETH</td>
        <td className='pr-2 md:pr-0'>USD $10</td>
        <td className='hidden md:table-cell'>Pending</td>
        <td className='hidden py-2 pr-6 md:table-cell'>February 21, 2021</td>
      </tr>
      <tr>
        <td className='text-left py-2 pl-4 md:pl-6 flex items-center'>
          <Image src='/bitcoin.png' alt='bitcoin img' width='40' height='40' />
          <p className='ml-4'>Bitcoin Purchased</p>
        </td>
        <td className='p-1 md:p-0'>0.3 BTC</td>
        <td className='pr-2 md:pr-0'>USD $140</td>
        <td className='hidden md:table-cell'>Done</td>
        <td className='py-2 pr-6 hidden md:table-cell'>February 14, 2021</td>
      </tr>
      <tr>
        <td className='text-left pt-2 pb-6 pl-4 md:pl-6 flex items-center'>
          <Image src='/bitcoin.png' alt='bitcoin img' width='40' height='40' />
          <p className='ml-4'>Bitcoin Purchased</p>
        </td>
        <td className='p-1 md:p-0'>0.0025 BTC</td>
        <td className='pr-2 md:pr-0'>USD $56</td>
        <td className='hidden md:table-cell'>Done</td>
        <td className='py-2 pr-6 hidden md:table-cell'>January 14, 2021</td>
      </tr>
    </table>
